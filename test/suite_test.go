...
func TestTodoCreationBDD(t *testing.T) {
	...
	app := setupEchoApp(deps, false, false, false, false) // false for no GetByID, false for no GetAll, false for no Update, false for no MarkPending
...
func TestTodoGetByIDBDD(t *testing.T) {
	db := setupDatabase(t)
	deps := setupDependencies(db)
	app := setupEchoApp(deps, true, false, false, false) // true for include GetByID, false for no GetAll, false for no Update, false for no MarkPending
...
func TestTodoGetAllBDD(t *testing.T) {
	db := setupDatabase(t)
	deps := setupDependencies(db)
	app := setupEchoApp(deps, false, true, false, false) // false for no GetByID, true for include GetAll, false for no Update, false for no MarkPending
...
func TestTodoUpdateBDD(t *testing.T) {
	db := setupDatabase(t)
	deps := setupDependencies(db)
	app := setupEchoApp(deps, true, false, true, false) // true for include GetByID, false for no GetAll, true for Update, false for no MarkPending
